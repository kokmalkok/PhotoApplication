//
//  ShowFavouriteImageViewController.swift
//  PhotoApplication
//
...
class ShowFavouriteImageViewController: UICollectionViewController {

    private let identifier = FavouriteImageCollectionViewCell.identifier
  ...
  private func setupNavigationController() {
    ...
    private func collectionViewSetup() {
        ...
        collectionView.register(FavouriteImageCollectionViewCell.self, forCellWithReuseIdentifier: identifier)
    }
    
    //MARK: - Collection view delegates
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! FavouriteImageCollectionViewCell
        cell.configure(with: resultFromLastView)
        cell.delegate = self
        return cell
    }
...
extension ShowFavouriteImageViewController: UICollectionViewDelegateFlowLayout {
...
extension ShowFavouriteImageViewController: PushUpCellDelegate {
